...
<div class="container">
    ...
    <form id="apiForm" method="POST" onsubmit="showPopup(); return false;">
        ...
        <button type="button" onclick="window.location.href='https://t.me/RM_CYBER_TEAM'">Join Telegram Channel</button>
    </form>
    <div id="message"></div>
    <div class="credit">
        <p>Credit: <a href="https://t.me/RM_CYBER_TEAM" target="_blank">RM OWNER</a></p>
    </div>
</div>
